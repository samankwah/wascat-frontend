...
export const metadata: Metadata = { title: "About", description: "About the scope and responsible use of the WASCAT West African demonstration archive." };
...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="container-shell py-14 text-center"><p className="text-sm text-muted">WASCAT is an open research-infrastructure demonstration focused on West Africa. <Link href="/methods" className="font-bold text-sky">Read the methodology →</Link></p></section>
    </>
  );
}
