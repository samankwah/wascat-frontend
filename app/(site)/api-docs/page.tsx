...
import { ApiSidebarNav } from "@/components/api-sidebar-nav";
...
export default function ApiDocsPage() {
  return (
    <>
      <Breadcrumbs trail={[{ label: "Home", href: "/" }, { label: "API documentation" }]} />
      ...
      <section className="container-shell grid gap-12 py-14 lg:grid-cols-[220px_1fr] lg:py-20"><aside className="hidden lg:block"><ApiSidebarNav /></aside><div className="min-w-0 max-w-4xl">
