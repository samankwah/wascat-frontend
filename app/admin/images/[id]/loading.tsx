...
import { Skeleton, SkeletonLines, SkeletonPage } from "@/components/skeleton";
...
export default function AdminImageDetailLoading() {
  return (
        ...
        <div className="grid gap-6">
          <Panel>
            <PanelHeader
              ...
              description={<Skeleton className="h-3 w-72" />}
            />
            <div className="px-5">
          ...
          <Panel>
            <PanelHeader title={<Skeleton className="h-4 w-16" />} description={<Skeleton className="h-3 w-64" />} />
        ...
        <div className="grid content-start gap-6">
          <Panel>
            ...
            <div className="p-5">
              ...
              <SkeletonLines lines={2} className="mt-3" lineClassName="h-2.5" />
            </div>
          </Panel>

          <Panel>
            <PanelHeader title={<Skeleton className="h-4 w-16" />} description={<Skeleton className="h-3 w-40" />} />
